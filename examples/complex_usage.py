...
def generate_rpg_scenario(
    ...
    Args:
        game_style: Style of the game (heroic/gritty/epic/mystery)
        party_level: Level of the party (affects complexity)
        party_classes: List of character classes in the party
        environment: Type of environment (dungeon/city/wilderness)
        quest_type: Type of quest (combat/mystery/diplomacy)
        difficulty: Difficulty level (easy/medium/hard)
        magical_elements: Optional list of magical elements present
        environment_details: Optional details about the environment
        special_conditions: Optional list of special conditions
    """
    # Set up environment-specific details
    env_details = environment_details or {}

    # Build context with all our conditional variables
    context = {
